...
void lcd_sh1106_init(void);  // <== HÀM INIT RIÊNG
void lcd_sh1106_draw_screen(bool fill);  // Vẽ toàn bộ buffer
void lcd_sh1106_draw_text(int x, int y, const char *text);
void lcd_sh1106_draw_text_and_qr(int text_x, int text_y, const char* text, int qr_x, int qr_y, const char* qr_data, int qr_scale);

static char box_id[128];
